...
# ==============================================================================
# Script de mise à jour du Dépôt APT Task Manager & GitHub Pages
# ==============================================================================
...
echo "=================================================="
echo " Task Manager APT Repository & GitHub Pages Sync"
echo "=================================================="

# Ensure we have deb and qsi packages
DEB_FILES=($(find "$REPO_DIR" -maxdepth 1 -name "taskmgr_*_amd64.deb" | sort -V -r))
if [ ${#DEB_FILES[@]} -eq 0 ]; then
    echo "Error: No taskmgr_*_amd64.deb package found in $REPO_DIR." >&2
    echo "Please run ./build_deb.sh first." >&2
    exit 1
fi

QSI_FILES=($(find "$REPO_DIR" -maxdepth 1 -name "setup_taskmgr_*.qsi" | sort -V -r))
APPIMAGE_FILES=($(find "$REPO_DIR" -maxdepth 1 -name "taskmgr-*.AppImage" | sort -V -r))

PAGES_DIR=$(mktemp -d -t taskmgr-gh-pages-XXXXXX)
...
LATEST_VERSION=$(grep '#define TASKMGR_VERSION "' "$REPO_DIR/src/taskmgr_version.h" 2>/dev/null | sed -E 's/.*"([^"]+)".*/\1/' || echo "1.2")
...
<head>
  ...
  <title>Task Manager v${LATEST_VERSION} - APT Repository</title>
  <link rel="icon" type="image/png" href="favicon.png">
  <meta name="description" content="Official APT Repository and download portal for Task Manager - High-performance system monitor and task manager for Trinity Desktop Environment (TDE) & Linux.">
  <style>
    :root {
      --bg: #12141a;
      --card-bg: #1c1f2b;
...
<body>
  <div class="container">
    <header>
      ...
      <p class="lead">Advanced Task Manager &amp; System Performance Monitor for Trinity Desktop Environment (TDE) and Linux systems.</p>
    </header>
    ...
    <div class="card">
      ...
      <div class="code-container">
        <pre id="apt-code"><code>echo "deb [trusted=yes] https://seb3773.github.io/taskmgr/ stable main" | sudo tee /etc/apt/sources.list.d/taskmgr.list
sudo apt update
sudo apt install taskmgr</code></pre>
    ...
    <div class="card">
      ...
      <div class="downloads-grid">
        <div class="download-card">
          ...
          <a href="pool/main/t/taskmgr/${LATEST_DEB_NAME}" class="btn-download">
            Download .deb
          </a>
        </div>
    ...
    <div class="card">
      ...
      <div class="features-grid">
        <div class="feature-item">
          ...
          <div class="feature-title">Process Tree &amp; Memory (PSS)</div>
          <div class="feature-text">Virtual tree hierarchy, fast signal sending, priority controls, and SSE2 SIMD-accelerated Proportional Set Size (PSS) analysis.</div>
        </div>

        <div class="feature-item">
          <span class="feature-icon">📊</span>
          <div class="feature-title">Real-Time Performance Graphs</div>
          <div class="feature-text">Smooth scrolling anti-aliased graphs for CPU (total &amp; per-core), RAM, Swap, Disk I/O, Network, and GPU activity with Compact Mode.</div>
        </div>

        <div class="feature-item">
          <span class="feature-icon">🚀</span>
          <div class="feature-title">Startup Applications Manager</div>
          <div class="feature-text">Manage autostart applications for standard XDG autostarts as well as native Trinity Desktop (TDE) conditional launches.</div>
        </div>

        <div class="feature-item">
          <span class="feature-icon">⏰</span>
          <div class="feature-title">Scheduled Tasks &amp; Cron</div>
          <div class="feature-text">Inspect, toggle, run, edit, and delete cron jobs and system scheduled scripts with instant crontab save synchronization.</div>
        </div>

        <div class="feature-item">
          <span class="feature-icon">⚙️</span>
          <div class="feature-title">Systemd Services Control</div>
          <div class="feature-text">Inspect, start, stop, restart, enable, or disable systemd services with ephemeral root elevation support.</div>
        </div>

        <div class="feature-item">
          <span class="feature-icon">👥</span>
          <div class="feature-title">Users &amp; Sessions Monitor</div>
          <div class="feature-text">Track connected users and their session resource consumption with one-click user disconnect functionality.</div>
        </div>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div class="screenshots-grid">
        <div class="screenshot-thumb" onclick="openModal('screenshots/screenshot_taskmgr_1.jpg')">
          <img src="screenshots/screenshot_taskmgr_1.jpg" alt="Processes Tab">
        </div>
        <div class="screenshot-thumb" onclick="openModal('screenshots/screenshot_taskmgr_2.jpg')">
          <img src="screenshots/screenshot_taskmgr_2.jpg" alt="Performance CPU">
        </div>
        <div class="screenshot-thumb" onclick="openModal('screenshots/screenshot_taskmgr_3.jpg')">
          <img src="screenshots/screenshot_taskmgr_3.jpg" alt="Performance Memory">
        </div>
        <div class="screenshot-thumb" onclick="openModal('screenshots/screenshot_taskmgr_4.jpg')">
          <img src="screenshots/screenshot_taskmgr_4.jpg" alt="Performance Disk">
        </div>
        <div class="screenshot-thumb" onclick="openModal('screenshots/screenshot_taskmgr_5.jpg')">
          <img src="screenshots/screenshot_taskmgr_5.jpg" alt="Performance Network">
        </div>
        <div class="screenshot-thumb" onclick="openModal('screenshots/screenshot_taskmgr_7.jpg')">
          <img src="screenshots/screenshot_taskmgr_7.jpg" alt="Startup Tab">
        </div>
        <div class="screenshot-thumb" onclick="openModal('screenshots/screenshot_taskmgr_9.jpg')">
          <img src="screenshots/screenshot_taskmgr_9.jpg" alt="Services Tab">
        </div>
        <div class="screenshot-thumb" onclick="openModal('screenshots/screenshot_taskmgr_10.jpg')">
          <img src="screenshots/screenshot_taskmgr_10.jpg" alt="Users Tab">
        </div>
      </div>
    </div>
    ...
    <!-- Footer -->
    <footer>
      <p>Source Code &amp; Releases: <a href="https://github.com/seb3773/taskmgr" target="_blank" rel="noopener">github.com/seb3773/taskmgr</a></p>
